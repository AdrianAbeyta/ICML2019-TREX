...
```
## Killing Gazbeo
Sometimes the Gazebo application can remain open in the background after training and cause some issues later on when trying to retrain.  Set the following alias in your .bashrc to kill all gzservers and gzclients. By typing killgazebo in your terminal,this will ensure all background gazebo applications have been properly shut down.
```
